var Te=Object.defineProperty;var Fe=(p,e,a)=>e in p?Te(p,e,{enumerable:!0,configurable:!0,writable:!0,value:a}):p[e]=a;var l=(p,e,a)=>Fe(p,typeof e!="symbol"?e+"":e,a);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))t(i);new MutationObserver(i=>{for(const s of i)if(s.type==="childList")for(const n of s.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&t(n)}).observe(document,{childList:!0,subtree:!0});function a(i){const s={};return i.integrity&&(s.integrity=i.integrity),i.referrerPolicy&&(s.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?s.credentials="include":i.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function t(i){if(i.ep)return;i.ep=!0;const s=a(i);fetch(i.href,s)}})();class Ie{constructor(e){l(this,"gl");l(this,"canvas");this.canvas=e;const a=e.getContext("webgl2",{alpha:!1,antialias:!0,depth:!0});if(!a)throw new Error("WebGL2 not supported");this.gl=a,this.validateExtensions(),this.logInfo()}validateExtensions(){const e=["EXT_color_buffer_float"];for(const a of e)if(!this.gl.getExtension(a))throw new Error(`Required WebGL extension not available: ${a}`)}logInfo(){const e=this.gl;console.log("✓ WebGL2 Context Created"),console.log("  Vendor:",e.getParameter(e.VENDOR)),console.log("  Renderer:",e.getParameter(e.RENDERER)),console.log("  Version:",e.getParameter(e.VERSION)),console.log("  GLSL Version:",e.getParameter(e.SHADING_LANGUAGE_VERSION))}resize(e,a){this.canvas.width=e,this.canvas.height=a,this.gl.viewport(0,0,e,a)}clear(e,a,t){this.gl.clearColor(e,a,t,1),this.gl.clear(this.gl.COLOR_BUFFER_BIT|this.gl.DEPTH_BUFFER_BIT)}}const De=`#version 300 es
